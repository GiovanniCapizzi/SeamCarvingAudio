...
# CHIRP 1 ------------------------------------------------
Ar = .3                                 # amplitude
fi1 = 1500.0                              # initial frequency
ff1 = 1000.0                              # final frequency
phi0 = 0                                
...
# CHIRP 2 ------------------------------------------------
fi2 = 1100.0                              # initial frequency
ff2 = 2000.0                              # final frequency
phi0 = 0                                
# linear frequency sweep
...
UF.wavwrite(zs, fs, "{0}s-chirps[{1}-{2};{3}-{4}];noise[{5},{6},{7}].wav".format(timeLength, fi1, ff1, fi2, ff2, noiseAmp, noiseWidth, noiseLocation))